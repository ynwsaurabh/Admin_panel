...
const editResult = ({ params }) => {
    ...
    const handleUpload = async () => {
        ...
        const resultStorageRef = Sref(storage, '/pdf' + `/${getData.pdfTitle}`)
        await deleteObject(resultStorageRef)
        const resultStorageRef2 = Sref(storage, '/pdf' + `/${selectedFiles.name}`)
        await uploadBytes(resultStorageRef2, selectedFiles.file);
        const downloadURL = await getDownloadURL(resultStorageRef2);
        const Data = {
            pdfTitle: selectedFiles.name,
            pdfUrl: downloadURL,
            resultName: selectedFiles.name,
            uniqueKey: id,
        }
        await set(resultDbRef, Data).then(() => {
    ...
    return (
        <div className="editResultWrapper">
            <div className="editResultContainer">
                <div className="editResultHeader">
                    <h4 className="header">EDIT RESULT</h4>
                ...
                <div className="editResultForm">
                    {getData &&
                        <div>
                            <b> Previous Selected</b>
                            <ul className='todos container'>
                                <a target='_blank' href={getData.pdfUrl}>
                                    <li className="todo">
                                        <div className='toggle-primary'>
                                            ...
                                            <span className="todo-title"> {getData.pdfTitle} </span>
                                        </div>
                                    </li>
                                </a>
                            </ul>
