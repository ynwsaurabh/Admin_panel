...
const AddFaculty = () => {
  ...
  const handleSubmit = async(e) =>{
    ...
    const childRef = ref(db, `Faculty/${department}` + `/${key}`)
    ...
    <div className="editProfileWrapper">
      <form className="editProfileContainer" onSubmit={handleSubmit}>
        <div className="editProfileHeader">
          <h4 className="header">ADD FACULTY</h4>
        </div>
        ...
        <button type="submit" className="btn editBtn"> Add Faculty </button>
      </form>
    </div>
    </>
  )
